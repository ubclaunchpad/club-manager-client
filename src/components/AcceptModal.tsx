...
class AcceptModal extends React.Component<IAcceptModalProps> {
                ...
                <div className={`modal ${this.props.isActive ? 'is-active' : ''}`}>
                    ...
                    <div className="modal-card">
                        <section className="modal-card-body py-5">
                            ...
                            />
                            <header>
                                <h1 className="is-size-3 has-text-weight-bold">Accept Applicant:</h1>
                                <p className="is-size-5 mt-4">This will send an offer to the applicant:</p>
                            </header>
