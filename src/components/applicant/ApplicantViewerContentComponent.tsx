...
class ApplicantViewerContentComponent extends React.Component<{
    interest: string; mainPlatform: string; allPlatforms: string; project: string; projectLink: string}>{
    render(): React.ReactNode {
        return (
            <div className="applicant-content">
                <div className="box">
                    <p><strong>Why are you interested in joining Launch Pad? (~200 words)</strong></p>
                    <p>{this.props.interest}</p>
                </div>

                <div className="box">
                    <p><strong>Which platforms are you most experienced with?</strong></p>
